...
<Hero></Hero>
<section class="-mt-16">
    <div class="font-main-font bg-[#0563C1] text-[#fff0dd] py-14 px-32 sm:py-32 <sm:flex <sm:flex-col sm:px-16 font-main-font text-[1.3rem]">
        <ul class="list-disc  sm:mt-5">
            <li class="pb-6">Only place in Sheboygan to get new/current comics.</li>
            <li class="">Independently owned and operated.</li>
        </ul>
    </div>
</section>
